...
public class StrategyBuilder {
    ...
    private List<Predicate<Datapoint>> predicates = new ArrayList<>();
    ...
    public List<Predicate<Datapoint>> buildCriteria(QueryOperation queryOperation, ODataRequestContext requestContext)
    ...
    private void buildFromSelect(SelectOperation selectOperation) {
        LOG.debug("Selecting all datapoints, no predicates needed");
    }
    ...
    private void buildFromSelectByKey(SelectByKeyOperation selectByKeyOperation) {
        ...
        predicates.add(dt -> dt.getId().equalsIgnoreCase(personId));
    }
    ...
    private Object getPersonField(Datapoint person, String propertyName) {
        try {
